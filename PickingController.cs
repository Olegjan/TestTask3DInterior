...
namespace BitBenderGames {
  ...
  [RequireComponent(typeof(AndroidCameraTouch))]
  public class PickingController : MonoBehaviour {
    ...
    private AndroidCameraTouch mobileTouchCam;
    ...
    public void Awake() {
      mobileTouchCam = FindObjectOfType<AndroidCameraTouch>();
      if (mobileTouchCam == null) {
        Debug.LogError("No AndroidCameraTouch found in scene. This script will not work without this.");
      }
